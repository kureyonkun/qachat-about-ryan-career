...
- Leads a geographically distributed team across Singapore, Atlanta, and Edinburgh — managing across time zones through deliberate scheduling, including late-night US overlap sessions, and leveraging the Singapore-Edinburgh timezone alignment for real-time collaboration
...
- Adapted management approach for a neurodivergent direct report — restructuring work to align with her strengths, providing organisational and prioritisation tools, and delivering carefully calibrated feedback — resulting in consistent project delivery, strong stakeholder recognition, and acceptance into a selective high-potential accelerator programme with a 20% acceptance rate
...
- **AI agent initiative:** Currently leading the integration of AI agents into the Aladdin build process as product owner, defining use cases and driving cross-team adoption aligned with strategic platform objectives
...
**About the Role:**
Within the same Aladdin Platform department, this role focused on managing and supporting the connectivity layer between Aladdin and its institutional clients — encompassing client onboarding, connectivity design and delivery, and ongoing connectivity support. Ryan progressed through three distinct functions during this tenure: Global Lead of Connectivity Support (primary role), a short stint in environment build as an individual contributor, before being promoted to lead New Products & Engineering in January 2023.

**Team Structure:**
- Led a globally distributed team of 6 engineers with 2 direct reports
- Reports to: Aladdin Platform Client Engagement leadership
...
- Collaborated with incident management teams post-resolution to identify root causes and implement gap remediation with internal and client technology teams to prevent recurrence
- Managed third-party vendor that provides onsite technicians for work at client sites, including handling the relationship with that vendor (engagement) and making sure they met their service-level agreements (SLAs).

**Due Diligence Function** *(Sole Owner, 2018–2020)*

- Assigned sole ownership of the due diligence function — maintaining a centralised knowledge base of approved answers covering the entire Aladdin technology stack, including servers, databases, operating systems, and programming languages
- Served as the internal interpreter and single point of contact for due diligence queries — translating complex technical information into coherent, accurate responses for internal stakeholders
- Collaborated with SMEs across technology teams to source and validate answers for new or evolving questions
- Built an automated email notification system using HTML, JavaScript, and Confluence to periodically prompt SMEs for updates on technology stack versioning changes — reducing manual follow-up and ensuring the knowledge base remained current
...
**Assistant Vice President — Systems Engineer, Technology Infrastructure Market Data Support**
*August 2010 – December 2016*
*Alternative titles: Market Data Engineer | Infrastructure Support Engineer | Systems Support Analyst | Technology Operations Analyst | IT Infrastructure Specialist*

**About the Role:**
Individual contributor role within the Technology Infrastructure Market Data Support team in Tokyo, responsible for supporting and maintaining enterprise-scale market data systems delivering real-time financial data — including prices, rates, and indices — to traders and business units across multiple global divisions.

**Team Structure:**
- Part of a team of 4 in Japan; broader APAC team of ~7
...
- Supported and maintained enterprise-scale market data infrastructure (Reuters, Bloomberg, ITRS) across multiple global business units — ensuring continuity of real-time market data services to traders and internal stakeholders
- Managed relationships with Japanese financial exchanges including the Japan Exchange Group and Osaka Exchange — liaising directly in Japanese with vendors and exchange representatives and translating outcomes for the wider English-speaking team
- Oversaw vendor change management, coordinating smooth implementation of platform updates and upgrades across market data systems
- Monitored system health and performance using ITRS — collaborating with the team to configure and modify the platform to fit organisational needs, including creating custom alerts for performance thresholds, feed outages, and latency issues
- Delivered IT operations support ensuring continuity of market data services across the organisation

---

### Deutsche Securities Inc. (Deutsche Bank Group), Japan
**IT Support Technician**
*December 2007 – July 2010*
*Alternative titles: IT Support Analyst | Desktop Support Engineer | End User Computing Specialist | IT Operations Technician | Service Desk Analyst*

**About the Role:**
Full-time contractor role in Tokyo within the Information Technology department of Deutsche Securities Inc., providing enterprise-wide IT support to over 1,000 business users — primarily traders and middle office staff — performing all functions bilingually in Japanese and English.

---

#### Responsibilities

- Delivered enterprise-wide desktop and market data application support to 1,000+ business users — receiving, diagnosing, and resolving IT issues across desktop hardware, software, mobile devices, printers, network, and proprietary applications
- Supported installation and deployment of market data applications including Bloomberg, Reuters, and Datastream
- Liaised with vendor support contacts, network, messaging, Unix, and database teams to resolve technical issues and meet user requests
- Served as the central reference and main technical support for BlackBerry devices in Japan — providing guidance to business users and engineers, maintaining essential documentation and user manuals, and coordinating with the mobile network provider, messaging team, and BlackBerry support in the United States
- Led new hire IT setup — preparing desktop and mobile devices, configuring network and email accounts, and providing system application training for newly onboarded employees
- Created and maintained a knowledge base of IT resolutions, manuals, and support procedures for team use
- Participated in the Disaster Recovery Solutions Exercise of 2009 — monitoring hardware health at the backup site, scheduling replacements and repairs, and providing periodic reports on hardware failures
- Performed all duties bilingually in Japanese and English across a multinational organisation

---

### Microsoft Co., Ltd., Japan
**QA Engineer / Software QA Test & Project Support (Contract via Hays Specialist Recruitment)**
*March 2007 – November 2007*
*Alternative titles: QA Analyst | Software Test Engineer | Application Support Analyst | Technical Liaison | User Acceptance Test Engineer*

**About the Role:**
Short-term contract role in Tokyo, placed via Hays Specialist Recruitment, supporting the marketing technology team at Microsoft Japan. Acted as liaison between Japanese business users and US-based engineers and developers across a suite of internal web-based tools and applications.

---

#### Responsibilities

- Supported and maintained internal marketing tools and applications including Bulk Emailer Tool, Microsoft.com Registration Form Application, API Implementation for Website, Personal Information Database, and ADHOC Canned Reports Database
- Served as the key liaison between Japanese business users and US-based Tier 2/3 engineers and developers — communicating product features, new software releases, future product roadmaps, scheduled downtimes, and business impact of incidents
- Received, reproduced, and validated bug reports — escalating product bugs and unplanned service downtimes to US-based engineers and developers with appropriate business severity and impact, and following through until resolution via hotfixes or new version releases
- Escalated new feature requests from business users to US engineering teams — providing detailed business expectations and justification to support development prioritisation
- Conducted User Acceptance Testing (UAT) for new version releases
- Applied technical knowledge across C#, ASP, ASP.NET, SQL, POP, SMTP, and HTTP protocols to effectively communicate with and support US-based development teams

---

### Brastel Telecom, Japan
**System Planner (Full-time)**
*May 2006 – February 2007*
*Alternative titles: IT Systems Analyst | Web Developer | Junior Systems Engineer | IT Operations Coordinator | Technical Project Coordinator*

**About the Role:**
Promoted to full-time System Planner upon graduation — a direct recognition of performance delivered during two years of part-time work while completing studies at Yomiuri Institute of Technology.

---

#### Responsibilities

- Developed and maintained customer-facing websites and internal tools using C#, HTML, JavaScript, CSS, and SQL — including mobile website development and translation tool updates
- Developed a Postal Code Updater Tool — learning tool requirements, formulating an approach to extract and parse HTML strings from a public website, uploading data to the system database without corrupting existing data, and providing documentation and user training
- Led the Hong Kong International Calling Card product launch as project manager — liaising with the Marketing department and overseas carrier vendors, coordinating cross-functional delivery from planning through to go-live
- Supported deployment of charging devices to external customers — providing installation support, user guides, and assistance
- Initiated and maintained a centralised knowledge base of IT resolutions to improve team knowledge consistency and efficiency of user support
- Performed daily health checks of company-wide systems, services, and IT infrastructure including servers, PBX, and intranet

---

### Brastel Telecom, Japan
**Carrier Operations & Support Team Member (Part-time)**
*September 2004 – April 2006*
*Alternative titles: IT Support Technician | Carrier Operations Assistant | Technical Support Officer | Junior IT Analyst | Help Desk Technician*

**About the Role:**
Part-time role undertaken while studying at Yomiuri Institute of Technology — combining IT support and carrier operations responsibilities across 25 hours per week. Hired full-time upon graduation as direct recognition of performance.

---

#### Responsibilities

- Provided enterprise-wide IT support for desktop devices, servers, PBX, and intranet — receiving and resolving IT requests from business users
- Liaised with in-house engineers, developers, and overseas vendor contacts to resolve technical issues and meet user requests
- Handled escalations from the customer service department regarding vendor phone line quality issues — coordinating with overseas carrier vendors to resolve line issues
- Performed daily health checks of company products, services, and IT infrastructure
- Documented IT issues and resolutions to support team knowledge sharing

---

## Education

**Master of Information Systems** *(In Progress)*
...
- Completed remotely as a bridging programme

**Diploma in Computer Programming** *(Full Monbukagakusho/MEXT Scholarship)*
Yomiuri Institute of Technology, Japan | 2004 – 2006
- Awarded a full Japanese Government MEXT scholarship — one of the most competitive government scholarships globally — to study computer programming in Japan

**Japanese Language Course** *(Monbukagakusho/MEXT Scholar)*
Bunka International Language School, Japan | 2003 – 2004
- Completed a full Japanese language immersion programme under MEXT scholarship prior to technical studies
...
- Cloud Infrastructure & Multi-Cloud Architecture (Azure, AWS)
- Network Connectivity Design & Implementation
- Cybersecurity & Compliance (FIPS, Data Domicility, Encryption at Rest & in Transit)
- Financial Services Technology (Asset Management, Trading, Risk)
...
- Distributed Team Leadership & People Management
- Inclusive Leadership & Neurodiversity-Aware Management
- Stakeholder Management (Business & Technology Leaders, Enterprise Clients, Compliance Teams)
...
- Technical Presentations & Architecture Reviews
- Regulatory Compliance Advisory
- Vendor & Exchange Relationship Management
- Bilingual Client Engagement (English & Japanese)
...
| Microsoft Certified Professional (MCP) | Microsoft | December 2009 |
| CompTIA Security+ | CompTIA | January 2010 |
| Cisco Certified Network Associate (CCNA) | Cisco | 2011 |
| C Programming Language Skills Examination — 3rd Grade | Certify Information Processing Skills Accreditation Committee (Japan) | February 2005 |
...
### Colab Residences — Residential Apartment Development & Operations
*Metro Manila, Philippines | October 2024 – May 2026*

A personal entrepreneurial project involving the end-to-end development and operationalisation of a 10-unit, 3-floor residential apartment building with parking, located in Metro Manila, Philippines. The project was conceived, managed, and delivered remotely from Singapore at a total build cost of approximately PHP 13 million.

- Initiated and scoped the full development project — engaging and managing an architect for building design, a contractor for construction, and a third-party administrator as on-ground oversight
- Managed the 8-month construction phase remotely from Singapore — conducting weekly huddles with the architect, contractor, and administrator to track progress, resolve issues, and maintain delivery momentum
- Self-directed learning of construction concepts throughout the project to enable informed decision-making and effective oversight of professional teams
- Managed post-handover business operations — including advertising and marketing to attract tenants, achieving full occupancy
- Designed and implemented the operational model for the business: online banking for rent collection, online form submission for tenant issue tracking, and Google Sheets for expense and profit tracking
- Handed over day-to-day management to a local partner upon completion of the operating model — transitioning to passive partner status while retaining ownership
- Building is currently at full occupancy and operating profitably

---

## Volunteer & Community Work

*No volunteer or community work to note at this time.*
...
*— End of Master Career Portfolio (Work in Progress) —*
